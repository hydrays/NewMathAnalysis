...
> \begin{aligned}
> \text{面积}
> &= 0.25 \times [f(0) + f(0.25) + f(0.5) + f(0.75)] \\
> &= 0.25 \times [0 + 0.0625 + 0.25 + 0.5625] \\
> &= 0.25 \times 0.875 = 0.21875
> \end{aligned}
> $$
> 
> **右矩形法**：
...
> \begin{aligned}
> \text{面积}
> &= 0.25 \times [f(0.25) + f(0.5) + f(0.75) + f(1.0)] \\
> &= 0.25 \times [0.0625 + 0.25 + 0.5625 + 1.0] \\
> &= 0.25 \times 1.875 = 0.46875
> \end{aligned}
> $$
