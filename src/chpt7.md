...
> 
> 其中：  
> - $\displaystyle T(t)$：物体在时间 $t$ 的温度.
> - $\displaystyle T_{\text{env}}$：环境温度（常数）.
> - $k$：冷却系数，$k > 0$.
>   
> **求解过程（分离变量法）**
> 1. 将方程整理为：
...
>
> **解释**
> 如果 $P > rB_0$，余额 $B(t)$ 随时间逐渐减少，最终贷款将被还清；反之，如果 $\displaystyle P \leq rB_0$，贷款余额将持续增长.
