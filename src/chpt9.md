...
> $$
>
> 以下我们规定所有的向量都采用竖着写的形式. 所以当我们说 $\mathbf{x}$ 时, 指的是 $\displaystyle \left(\begin{matrix} x_1 \\ x_2 \\ \vdots \\  x_n \end{matrix} \right)$, 为了节省空间, 我们可以把上述向量写成 $(x_1, x_2, \cdots, x_n)^T$, 这里的 T 不是躺平的躺的意思, 而是 **转置** (Transpose).
...
> **形属性下的点乘**
>
> 向量 $\mathbf{u}$ 与向量 $\mathbf{v}$ 的内积等于其中一个向量 $\mathbf{u}$ 在另一个向量 $\mathbf{v}$ 的方向上**投影**的长度(带符号)乘以向量 $\mathbf{v}$ 本身的长度. 也可以写成:
> $$
...
::: {.exercise id="chpt9-ex-001"}
:::

::: {.exercise id="chpt9-ex-002"}
:::

::: {.exercise id="chpt9-ex-003"}
:::

::: {.exercise id="chpt9-ex-004"}
:::

::: {.exercise id="chpt9-ex-005"}
:::

::: {.exercise id="chpt9-ex-006"}
:::
...
> **二次曲面**
>
> 在中学我们还学过二维空间中的抛物线, 如 $y = x^2$, 它关于 $x$ 是二次的. 我们还学过双曲线和椭圆, 如 $\frac{x^2}{a^2} + \frac{y^2}{b^2} = 1$, 它关于 $x, y$ 也是二次的. 在三维空间我们也类似有这样的二次曲面, 其一般形式为
> $$
...
::: {.exercise id="chpt9-ex-007"}
:::

::: {.exercise id="chpt9-ex-008"}
:::
...
::: {.exercise id="chpt9-ex-009"}
:::

::: {.exercise id="chpt9-ex-010"}
:::
...
::: {.exercise id="chpt9-ex-011"}
:::

::: {.exercise id="chpt9-ex-012"}
:::